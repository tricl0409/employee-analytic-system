STRINGS = {
    "en": {
        ...
        "overview_anatomy_quant_tags": "Age,Fnlwgt,Education_Num,Hours_per_Week",
        ...
        "conclusion_subtitle": "Data-driven portrait of the typical High-Income earner — synthesized from all analysis dimensions.",
        ...
        "conclusion_profile_title": "Typical High-Income Profile",
        "conclusion_profile_hint": "Composite archetype derived from the top earners in the dataset.",
        "conclusion_profile_based_on": "Based on <b>{count}</b> high earners &nbsp;·&nbsp; <b>{pct}%</b> of dataset",
        "conclusion_trait_marital": "Marital Status",
        "conclusion_trait_role": "Household Role",
        "conclusion_trait_education": "Education",
        "conclusion_trait_occupation": "Occupation",
        "conclusion_trait_capital": "Capital Gain",
        "conclusion_trait_hours": "Work Hours",
        "conclusion_trait_age": "Prime Age Range",
        "conclusion_trait_gender": "Dominant Gender",
        "conclusion_trait_invest_label": "have investment income",
        "conclusion_trait_fulltime_label": "{pct}% full-time (\u226540h)",
        "conclusion_trait_avg_label": "Avg {val}h / week",
        "conclusion_trait_age_range_label": "{q1} – {q3} years",
        # -- Section 2: Key Message Delivery --
        "conclusion_msg_title": "Key Messages",
        "conclusion_msg_hint": "Actionable insights drawn from the analysis.",
        "conclusion_msg1_title": "Education Unlocks Doors",
        "conclusion_msg1_body": "The more you learn, the more opportunities you create for yourself. Higher education often leads to better jobs, stronger income potential, and wider career choices.",
        "conclusion_msg2_title": "Work Smarter, Not Just Harder",
        "conclusion_msg2_body": "Long hours alone don't guarantee success. What truly matters is what you work on — your occupation and the skills you build through education.",
        "conclusion_msg3_title": "Invest Early in Yourself",
        "conclusion_msg3_body": "The prime years for career growth are 36–55, but the foundation is laid much earlier. Start building your education and career path now so you can thrive when it counts most.",
